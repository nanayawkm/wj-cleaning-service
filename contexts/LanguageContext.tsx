...
const translations = {
  en: {
    ...
    // Contact form status. Wording matches the trust strip and the confirmation
    // email ("four working hours"); note sendMessageDesc above still says 24.
    contactSending: "Sending…",
    contactSuccessTitle: "Message sent",
    contactSuccessBody: "Thanks — we've got your message and emailed you a copy. We reply within four working hours.",
    contactSuccessReference: "Reference",
    contactErrorRequired: "Please add your name, a valid email, the service you need, and a message of at least 10 characters.",
    contactErrorRateLimited: "That's several messages in a short time. Please try again later, or call us instead.",
    contactErrorGeneric: "Your message could not be sent. Please try again, or call us on",
  ...
  nl: {
    ...
    // Zie de Engelse toelichting hierboven.
    contactSending: "Versturen…",
    contactSuccessTitle: "Bericht verzonden",
    contactSuccessBody: "Bedankt — wij hebben uw bericht ontvangen en een kopie naar u gemaild. Wij reageren binnen vier werkuren.",
    contactSuccessReference: "Referentie",
    contactErrorRequired: "Vul uw naam, een geldig e-mailadres, de gewenste dienst en een bericht van minimaal 10 tekens in.",
    contactErrorRateLimited: "Dat zijn meerdere berichten in korte tijd. Probeer het later opnieuw of bel ons.",
    contactErrorGeneric: "Uw bericht kon niet worden verzonden. Probeer het opnieuw of bel ons op",
    contactPrivacyNote: "Wij gebruiken uw gegevens alleen om deze vraag te beantwoorden.",
    name: "Naam",
    phone: "Telefoon",
    message: "Bericht",
    submit: "Indienen",
