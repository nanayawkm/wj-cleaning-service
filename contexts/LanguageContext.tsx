...
const translations = {
  ...
  nl: {
    ...
    ourStoryDesc: "Opgericht door William en Jennifer, een toegewijd echtpaar dat het belang van vertrouwen, betrouwbaarheid en aandacht voor detail begreep. Wat begon als een klein familiebedrijf is uitgegroeid tot een vertrouwde partner.",
