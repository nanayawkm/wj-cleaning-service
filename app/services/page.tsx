...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-wj-light/10 via-white to-wj-accent-light/10">
      ...
      <section className="relative py-32 bg-gradient-to-r from-wj-dark/90 to-wj-accent/90 text-white overflow-hidden">
        {/* Background Image */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="bg-white/30 text-white mb-6 backdrop-blur-md font-semibold">{t('ourServices')}</Badge>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <Badge className="bg-wj-light/20 text-wj-dark mb-4">{t('commercialIndustrial')}</Badge>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center flex-shrink-0 border-2 border-wj-dark">
                  <IconDroplet className="h-6 w-6 text-wj-dark" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">{t('comprehensiveCleaning')}</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Dusting and cleaning of all surfaces</span>
                </div>
                <div className="flex items-center space-x-3">
                  <IconCheck className="h-5 w-5 text-wj-accent flex-shrink-0" />
                  <span className="text-gray-700">Mopping and sweeping floors</span>
                </div>
                <div className="flex items-center space-x-3">
                  <IconCheck className="h-5 w-5 text-wj-accent flex-shrink-0" />
                  <span className="text-gray-700">Emptying dustbins and waste disposal</span>
                </div>
                <div className="flex items-center space-x-3">
                  <IconCheck className="h-5 w-5 text-wj-accent flex-shrink-0" />
                  <span className="text-gray-700">Cleaning and wiping of glass windows and doors</span>
                </div>
                <div className="flex items-center space-x-3">
                  <IconCheck className="h-5 w-5 text-wj-accent flex-shrink-0" />
                  <span className="text-gray-700">Bathroom and toilet cleaning</span>
                </div>
                <div className="flex items-center space-x-3">
                  <IconCheck className="h-5 w-5 text-wj-accent flex-shrink-0" />
                  <span className="text-gray-700">Removing empty crates and pallets that aren't needed</span>
                </div>
                <div className="flex items-center space-x-3">
                  <IconCheck className="h-5 w-5 text-wj-accent flex-shrink-0" />
                  <span className="text-gray-700">Ensuring aisles and passageways are clear of obstacles</span>
                </div>
              </div>
            ...
            <div className="relative group">
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-white rounded-2xl flex items-center justify-center shadow-lg border-2 border-wj-dark">
                <IconSparkles className="h-10 w-10 text-wj-dark" />
              </div>
            </div>
          </div>
        </div>
